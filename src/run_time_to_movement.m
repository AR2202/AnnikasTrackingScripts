...
function run_time_to_movement( threshold, varargin)
...
if round(nArgs/2) ~= nArgs / 2
    error('run_time_to_movement called with wrong number of arguments:expected Name/Value pair arguments')
end
