...
function run_time_to_threshold(column, threshold, above, outputdir,varargin)
...
if round(nArgs/2) ~= nArgs / 2
    error('run_time_to_threshold called with wrong number of arguments:expected Name/Value pair arguments')
end
...
if specificframes %not yet supported
    run_any('time_to_threshold_errors.log', 'time_to_threshold_frames')
else
run_any('time_to_threshold_errors.log', 'time_to_threshold',column, threshold, above, outputdir)
end