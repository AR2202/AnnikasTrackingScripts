...
ind_data = arrayfun(@(x, x2) horzcat(transpose(trk.data(x, :, 1)), transpose(trk.data(x, :, 2)), transpose(trk.data(x, :, 3)), transpose(trk.data(x2, :, 1)), transpose(trk.data(x2, :, 2)), transpose(feat.data(x, :, 4)), transpose(trk.data(x2, :, 3)), transpose(feat.data(x, :, 8)), transpose(feat.data(x, :, 9)), transpose(feat.data(x, :, 10)), transpose(trk.data(x, :, 11)), transpose(feat.data(x, :, 12)), transpose(feat.data(x2, :, 12)), transpose(trk.data(x, :, 14)), transpose(trk.data(x, :, 15)), transpose(trk.data(x, :, 16))), indices, ind2, 'UniformOutput', false);
%ind_data contains:
%  pos x=ind_data(:,:,1);
%  pos y=ind_data(:,:,2);
%ori = ind_data(:,:,3);
