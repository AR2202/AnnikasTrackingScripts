%MEAN_VELOCITY calculates the mean velocity of the flies in 'inputfilename'
%over the total duration specified as the 'dur'
%input parameter
...
function mean_velocity(inputfilename, dur, varargin)
