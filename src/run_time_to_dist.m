...
function run_time_to_dist( threshold, varargin)
...
if round(nArgs/2) ~= nArgs / 2
    error('run_time_to_dist called with wrong number of arguments:expected Name/Value pair arguments')
end
...
if specificframes %not yet supported
    ...
    10, threshold, false, 'time_to_dist')
else
