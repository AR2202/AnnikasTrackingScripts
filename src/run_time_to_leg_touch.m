...
function run_time_to_leg_touch( threshold, varargin)
...
if specificframes %not yet supported
    ...
    13, threshold, false, 'time_to_leg_touch')
else
run_any('time_to_threshold_errors.log', 'time_to_threshold', ...
    13, threshold, false, 'time_to_leg_touch')
end